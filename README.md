...
[![NPM Version](https://img.shields.io/badge/npm-1.0.0-blue.svg)](https://www.npmjs.com/package/@team-watson/schema-icu-sdk)
...
```bash
npm install @team-watson/schema-icu-sdk
```
...
```javascript
const { SchemaICU } = require('@team-watson/schema-icu-sdk');
...
```javascript
const { SchemaICU, Config } = require('@team-watson/schema-icu-sdk');
...
const { 
  ...
  RateLimitError,
  APIError 
} = require('@team-watson/schema-icu-sdk');
